...
const Map =()=> {
  return(<Svg
    ...
    >
      ...
      <Circle cx={1366.8594} cy={1900.377} r={2.3} fill="#4baf4f" id = "green-branch"/>
      ...
      <G transform="translate(209.06 306.377)">
        <Circle r={11.7} cy={1881.8} cx={1514.7} fill="#4baf4f" id = "green-branch" />
        <Path
      ...
      <G transform="translate(209.393 64.211)">
        <Circle r={11.7} cy={77} cx={631.29999} fill="#4baf4f" id = "green-branch" />
        <Path
