...
class Map extends React.Component{
    ...
    _lastScale = 1;
    _touchX = new Animated.Value(screen.width / 2 - circleRadius);
...
//    ],{useNativeDriver: true})
   render(){
    return(
        <GestureHandler.PanGestureHandler onGestureEvent={this._onPanGestureEvent}>
        <Animated.View
          style={{
            height: 150,
            justifyContent: 'center',
        ...
        <Circle cx={1366.8594} cy={1900.377} r={2.3} fill="#4baf4f" />
        ...
        <G transform="translate(209.06 306.377)">
            <Circle r={11.7} cy={1881.8} cx={1514.7} fill="#4baf4f" />
            <Path
        ...
        <G transform="translate(209.393 64.211)">
            <Circle r={11.7} cy={77} cx={631.29999} fill="#4baf4f" />
            <Path
